        ...
        <div class="brand-banner">
            <div class="banner-content">
                <div class="brand-icon">
                    <img src="{{ asset('landing_assets/images/logo/logo-light.png') }}" style="width: 150px"
                        alt="logo">
                </div>
        ...
        <div class="login-section">
            <div class="login-container">
                ...
                <div class="legal-note">
                    Dengan melanjutkan, Anda menyetujui <a href="#">Ketentuan Layanan</a> dan <a
                        href="#">Kebijakan Privasi</a>.<br>
                </div>
            </div>
        </div>
    </div>
